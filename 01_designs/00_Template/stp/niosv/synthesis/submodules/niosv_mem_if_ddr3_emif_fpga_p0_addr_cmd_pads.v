...
module niosv_mem_if_ddr3_emif_fpga_p0_addr_cmd_pads(
    reset_n,
    reset_n_afi_clk,
    pll_afi_clk,
    pll_mem_clk,
...
begin
     niosv_mem_if_ddr3_emif_fpga_p0_acv_ldc # (
...
begin
    ...
    niosv_mem_if_ddr3_emif_fpga_p0_clock_pair_generator    uclk_generator(
        .datain     (mem_ck_temp),
