...
module niosv_mem_if_ddr3_emif_fpga_p0_read_datapath(
	reset_n_afi_clk,
	seq_read_fifo_reset,
	reset_n_resync_clk,
	pll_dqs_ena_clk,
...
`endif
	...
	`endif
		...
		niosv_mem_if_ddr3_emif_fpga_p0_fr_cycle_shifter uread_fr_cycle_shifter(
			.clk (pll_afi_clk),
...
`endif
		...
		niosv_mem_if_ddr3_emif_fpga_p0_flop_mem	uread_valid_fifo(
...
begin
	...
	begin: read_buffering
		...
		begin : rd_valid_lfifo_sel
			...
			niosv_mem_if_ddr3_emif_fpga_p0_read_valid_selector uread_valid_selector(
				.reset_n		(reset_n_afi_clk),
		...
		begin : rd_enable_lfifo_sel
			niosv_mem_if_ddr3_emif_fpga_p0_read_valid_selector uread_valid_full_selector(
				.reset_n		(reset_n_afi_clk),
				.pll_afi_clk		(pll_afi_clk),
		...
		if (RD_ENABLE_LFIFO_WIDTH == 1) begin
			...
			niosv_mem_if_ddr3_emif_fpga_p0_simple_ddio_out	read_enable_from_lfifo_qr_to_hr(
				.reset_n    (reset_n_afi_clk),
				.clk        (pll_afi_clk),
				.dr_clk     (1'b1),
				.dr_reset_n (1'b1),
		...
		`else
		niosv_mem_if_ddr3_emif_fpga_p0_sim_delay #(
				.delay(10)
			)
			sim_delay_inst(
		...
		begin: read_subgroup
			...
			niosv_mem_if_ddr3_emif_fpga_p0_flop_mem	uread_fifo(
				.wr_reset_n (1'b1),
			...
			niosv_mem_if_ddr3_emif_fpga_p0_flop_mem	uread_fifo_neg(
				.wr_reset_n (1'b1),
